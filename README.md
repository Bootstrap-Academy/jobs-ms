<p>
  ...
  [![CI](https://github.com/Bootstrap-Academy/jobs-ms/actions/workflows/ci.yml/badge.svg)](https://github.com/Bootstrap-Academy/jobs-ms/actions/workflows/ci.yml)
...
#### SSH (recommended)
```bash
git clone --recursive git@github.com:Bootstrap-Academy/jobs-ms.git
```

#### HTTPS
```bash
git clone --recursive https://github.com/Bootstrap-Academy/jobs-ms.git
```
