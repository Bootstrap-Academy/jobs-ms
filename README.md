...
https://app.codecov.io/gh/Bootstrap-Academy/jobs-ms/settings/badge
[![codecov](https://codecov.io/gh/Bootstrap-Academy/jobs-ms/branch/develop/graph/badge.svg?token=changeme)](https://codecov.io/gh/Bootstrap-Academy/jobs-ms) -->
![Version](https://img.shields.io/github/v/tag/Bootstrap-Academy/jobs-ms?include_prereleases&label=version)

# Bootstrap Academy Jobs Microservice
The official jobs microservice of [Bootstrap Academy](https://bootstrap.academy/).
...
8. Run `poe api` to start the microservice. You can find the automatically generated swagger documentation on http://localhost:8003/docs.
